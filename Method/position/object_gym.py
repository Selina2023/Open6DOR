...
class ObjectGym():
    def __init__(
       ...
       # create sim
        ...
        self.franka_asset_root = self.cfgs["asset"]["franka_asset_root"]
    ...
    def prepare_franka_asset(self):
        ...
        self.franka_asset = self.gym.load_asset(self.sim, self.franka_asset_root, franka_asset_file, asset_options)
        ...
        for env_i in range(len(rgb_envs)):
            for cam_i in range(len(rgb_envs[0])):
                ...
                if depth_envs is not None and save_depth:
                    ...
                    fname = os.path.join(save_dir, f"{save_name}-depth-{env_i}-{cam_i}.npy")
                    np.save(fname, depth, allow_pickle=True)
            ...
            # import pdb; pdb.set_trace()
            if not len(points) == 0 and points is not None and save_pc:
                point_cloud = o3d.geometry.PointCloud()
...
# /home/haoran/Project/Open6DOR/Open6DOR_internal/assets/tasks/task_refine_*/*/*/*/isaac_render-depth-0-4.png
len(glob.glob("/home/haoran/Project/Open6DOR/Open6DOR_internal/assets/tasks/task_refine_pos/*/*/*/isaac_render-depth-0-4.png"))
len(glob.glob("/home/haoran/Project/Open6DOR/Open6DOR_internal/assets/tasks/task_refine_rot/*/*/*/isaac_render-depth-0-4.png"))